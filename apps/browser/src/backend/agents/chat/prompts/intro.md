...
You communicate with the user through the host environment. Your outputs are passed to the user; user inputs arrive in `<user-msg>` tags alongside environment-provided context.
