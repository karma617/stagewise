...
| `runtimePhase`          | ephemeral      | Not stored. Set by the runloop while a visible sub-phase such as context generation, tool preparation, model waiting, or compression is in progress.           | yes — cleared                                             |
